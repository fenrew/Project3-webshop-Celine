...
router.get("/models", (req, res) => {
  const newProductOne = Shop({
    ...
    price: 50,
    stock: true,
     image: "https://res.cloudinary.com/doecwsnly/image/upload/v1537710128/wild-orange.png",   
  ...
  const newProductTwo = Shop({
    ...
    price: 10,
    stock: true,
   image: "https://res.cloudinary.com/doecwsnly/image/upload/v1537710142/lavender.png",      
  ...
  const newProductThree = Shop({
    ...
    price: 30,
    stock: true,
   image: "https://res.cloudinary.com/doecwsnly/image/upload/v1537710122/oregano.png",       
  ...
  const newProductFour = Shop({
    ...
    price: 100,
    stock: true,
   image: "https://res.cloudinary.com/doecwsnly/image/upload/v1537710128/peppermint.png",    
  ...
  const newProductFive = Shop({
    ...
    price: 400,
    stock: true,
   image: "https://res.cloudinary.com/doecwsnly/image/upload/v1537710138/lemon.png",
  ...
  const newProductSix = Shop({
    ...
    price: 200,
    stock: true,
    image: "https://res.cloudinary.com/doecwsnly/image/upload/v1537710135/frankincense.png",  
  ...
  const newProductSeven = Shop({
    ...
    price: 200,
    stock: true,
   image: "https://res.cloudinary.com/doecwsnly/image/upload/v1537710120/rosemary.png",  
  ...
  const newProductEight = Shop({
    ...
    price: 200,
    stock: true,
   image: "https://res.cloudinary.com/doecwsnly/image/upload/v1537710129/on-guard.png",
  ...
  const newProductNine = Shop({
    ...
    price: 140,
    stock: true,
   image: "https://res.cloudinary.com/doecwsnly/image/upload/v1537710142/digest-zen.png",    
